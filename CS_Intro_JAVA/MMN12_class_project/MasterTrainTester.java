public class MasterTrainTester {
    public static void main(String[] args) {
        ...
        Train trc3 = new Train( tr3);
        Train trc4 = new Train( tr4);
        Train trc5 = new Train( tr5);
        Train trc6 = new Train( tr6);
        Train trc7 = new Train( tr7);
        Train tst;
        ...
        System.out.println("\taddPassengers: (20)    : get: " +tst.addPassengers(20)  +"\t: "+ tst.getPassengers());
